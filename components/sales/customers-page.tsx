                ...
                description={
                    selectedCustomer ? (
                        <div className="space-y-3">
                            ...
                            <div
                                className={`border rounded-lg p-3 ${selectedCustomer.status === "archived"
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <User
                                        className={`h-8 w-8 ${selectedCustomer.status === "archived"
                                                ? "text-red-600"
                                                : "text-amber-600"
                                            }`}
                                    />
                                    <div>
                                        <p
                                            className={`font-semibold ${selectedCustomer.status === "archived"
                                                    ? "text-red-800"
                                                    : "text-amber-800"
                                                }`}
                                        >
                                        ...
                                        <p
                                            className={`text-sm ${selectedCustomer.status === "archived"
                                                    ? "text-red-700"
                                                    : "text-amber-700"
                                                }`}
                                        >
